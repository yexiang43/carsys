...
<script type="text/javascript" src="${chao}/static/echarts/js/echarts.min.js"></script>
<script type="text/javascript" src="${chao}/static/echarts/js/jquery-3.1.1.min.js"></script>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function getData() {
            ...
            $.get("${chao}/stat/loadOpernameYearGradeStatJson.action",{year:year},function (data) {
