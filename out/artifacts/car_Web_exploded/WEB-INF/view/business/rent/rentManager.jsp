		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline" style="padding: 5px">
				<input type="text" name="carnumber" autocomplete="off" class="layui-input layui-input-inline"
					   placeholder="请输入车辆号码" style="height: 30px;border-radius: 10px">
			</div>
		</div>
		<div class="layui-inline">
		...
		<div class="layui-form-item">
				...
				<div class="layui-input-block" style="padding: 5px">
					<input type="text" name="rentid" autocomplete="off" class="layui-input"
						   placeholder="请输入出租单号" style="height: 30px;border-radius: 10px" readonly="readonly">
				</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-inline">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="padding: 5px">
					<input type="text" name="identity" autocomplete="off" class="layui-input layui-input-inline"
						   placeholder="请输入身份证号" readonly="readonly" style="height: 30px;border-radius: 10px">
				</div>
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline" style="padding: 5px">
					<input type="text" name="opername" autocomplete="off" class="layui-input layui-input-inline"
						   placeholder="请输入车辆号码" readonly="readonly" style="height: 30px;border-radius: 10px">
				</div>
			</div>
			</div>
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline" style="padding: 5px">
						<input type="text" name="begindate" readonly="readonly" autocomplete="off" class="layui-input layui-input-inline"
							   placeholder="请输入开始时间" style="height: 30px;border-radius: 10px">
					</div>
				</div>
				<div class="layui-inline">
					...
					<div class="layui-input-inline" style="padding: 5px">
						<input type="text" name="returndate" readonly="readonly" autocomplete="off" class="layui-input layui-input-inline"
							   placeholder="请输入开始时间" style="height: 30px;border-radius: 10px">
					</div>
				</div>
			</div>
		     <div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label">车辆状态:</label>
					<div class="layui-input-inline">
						<input type="radio" name="rentflag" readonly="readonly" value="1" title="已归还">
						<input type="radio" name="rentflag" readonly="readonly" value="0" title="未归还">
					</div>
				</div>
			</div>
			<div class="layui-form-item">
...
<script type="text/javascript">
	...
	layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
		...
		tableIns = table.render({
			...
			, url: '${chao}/rent/loadAllRent.action' //数据接口
			...
			, cols: [[   //列表数据
				...
				, {field: 'rentid', title: '出租单号', align: 'center',width: '120'}
				, {field: 'identity', title: '身份证号', align: 'center',width:'140'}
				, {field: 'price', title: '出租价格', align: 'center',width:'100'}
				, {field: 'carnumber', title: '车辆号码', align: 'center',width: '110'}
				, {field: 'begindate', title: '起始时间', align: 'center',width: '120'}
				, {field: 'returndate', title: '还车时间', align: 'center',width: '120'}
				, {field: 'rentflag', title: '车辆状态', align: 'center', width:'100',templet: function (d) {
		...
		$("#doSearch").click(function () {
			...
			//alert(params);
			tableIns.reload({
				url: "${chao}/rent/loadAllRent.action?" + params,
				page: {curr: 1}
			})
		});
		...
		table.on('tool(rentTable)', function (obj) {
			...
			if (layEvent === 'del') { //删除
				layer.confirm('真的删除【' + data.rentid + '】这个出租单么？', function (index) {
					//向服务端发送删除指令
					$.post("${chao}/rent/deleteRent.action", {rentid: data.rentid}, function (res) {
						layer.msg(res.msg);
						//刷新数据表格
						tableIns.reload();
					})
		...
		function openUpdateRent(data) {
			mainIndex = layer.open({
				...
				success: function (index) {
					...
					url = "${chao}/rent/updateRent.action";
				}
			});
		}
